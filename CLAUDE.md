...
| 入口地址 | 后端地址 | 用途 |
|---|---|---|
| `81.69.15.109:8317` | `114.111.176.35:13117` | 旧主端口兼容入口 |
| `81.69.15.109:8080` | `114.111.176.35:13117` | 旧 8080 兼容入口 |
| `81.69.15.109:8085` | `114.111.176.35:13185` | 备用端口 |
| `81.69.15.109:1455` | `114.111.176.35:13145` | gemini-cli 协议 |
| `81.69.15.109:54545` | `114.111.176.35:13154` | 备用端口 |
...
- `labels:` 必须有 `autoheal=true`，供 watchdog 识别
- `healthcheck:` 用 `wget -q --spider -T 4 http://127.0.0.1:8080/healthz`（busybox 兼容；`-T 4` 防止 healthcheck 进程堆积）
- `autoheal` sidecar 必须保留，用于容器 `unhealthy` 时自动重启 `cli-proxy-api`
